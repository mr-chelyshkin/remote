...
type TransportData struct {
	...
	LinkPath   string `protobuf:"bytes,2,opt,name=linkPath,proto3" json:"linkPath,omitempty"`
...
func (x *TransportData) GetRemotePath() string {
	if x != nil {
		return x.RemotePath
	}
	return ""
...
func (x *TransportData) GetLinkPath() string {
	if x != nil {
		return x.LinkPath
	}
	return ""
...
func (x *TransportData) GetFileName() string {
	if x != nil {
		return x.FileName
	}
	return ""
...
func (x *TransportData) GetExtension() string {
	if x != nil {
		return x.Extension
	}
	return ""
...
func (x *TransportData) GetMode() string {
	if x != nil {
		return x.Mode
	}
	return ""
...
func (x *TransportData) GetSize() int64 {
	if x != nil {
		return x.Size
	}
	return 0
...
func (x *TransportData) GetChunk() []byte {
	if x != nil {
		return x.Chunk
	}
	return nil
...
var file_request_proto_rawDesc = []byte{
	...
	0x02, 0x70, 0x62, 0x22, 0xc3, 0x01, 0x0a, 0x0d, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x70, 0x6f, 0x72,
	0x74, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1e, 0x0a, 0x0a, 0x72, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x50,
	0x61, 0x74, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x72, 0x65, 0x6d, 0x6f, 0x74,
	0x65, 0x50, 0x61, 0x74, 0x68, 0x12, 0x1a, 0x0a, 0x08, 0x6c, 0x69, 0x6e, 0x6b, 0x50, 0x61, 0x74,
	0x68, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6c, 0x69, 0x6e, 0x6b, 0x50, 0x61, 0x74,
	0x68, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20,
	...
	0x52, 0x09, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x12, 0x0a, 0x04, 0x6d,
	...
	0x69, 0x7a, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x05, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x2f, 0x70,
